...
<div class="modal fade " id="exampleModalLongdeld{{$item->id}}" tabindex="-1" role="dialog"
 ...
 <div class="jumbotron">
    <div class="row">
        <div class="col-6"> <a href="{{route('delete.university.details',['id'=>$item->id])}}"><span class="h4 text-danger">Yes</span> </a></div>
        <div class="col-6"> <a href="/admin/university-index"><span class="h4 text-dark">No</span></a></div>
    </div>
 </div>
